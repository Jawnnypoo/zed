 ...
 * using the {@link #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)} call.
 * <p>
 * <h3>Initializing GLSurfaceView</h3>
 * All you have to do to initialize a GLSurfaceView is call {@link #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)}.
 * However, if desired, you can modify the default behavior of GLSurfaceView by calling one or
 * more of these methods before calling setRenderer:
 * <ul>
 * <li>{@link #setDebugFlags(int)}
 * <li>{@link #setEGLConfigChooser(boolean)}
 * <li>{@link #setEGLConfigChooser(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLConfigChooser)}
 * <li>{@link #setEGLConfigChooser(int, int, int, int, int, int)}
 * <li>{@link #setGLWrapper(com.jawnnypoo.zed.graphics.GLSurfaceView.GLWrapper)}
 * </ul>
 * <p>
 ...
 * Finally, you must call {@link #setRenderer} to register a {@link com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer}.
 * The renderer is
...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * {@link com.jawnnypoo.zed.graphics.GLSurfaceView.GLWrapper#wrap(javax.microedition.khronos.opengles.GL)} method is called
     ...
     * <p>If this method is
     * called, it must be called before {@link #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)}
     * is called.
     * <p>
     ...
     * <p>If this method is called, it must be called before {@link #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)}
     * is called.
     * <p>This method only affects the behavior of the default EGLContexFactory and the
     * default EGLConfigChooser. If
     * {@link #setEGLContextFactory(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLContextFactory)} has been called, then the supplied
     * EGLContextFactory is responsible for creating an OpenGL ES 2.0-compatible context.
     * If
     * {@link #setEGLConfigChooser(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLConfigChooser)} has been called, then the supplied
     ...
     * <p>
     * This method can only be called after {@link #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)}
     *
    ...
    public void flushTextures(TextureManager library) {
        mGLThread.flushTextures(library);
    }
    
    public void loadTextures(TextureManager library) {
        mGLThread.loadTextures(library);
    }
    
    public void flushBuffers(BufferManager library) {
        mGLThread.flushBuffers(library);
    }
    
    public void loadBuffers(BufferManager library) {
     ...
     * }
     * </pre>
     * @see #setGLWrapper(com.jawnnypoo.zed.graphics.GLSurfaceView.GLWrapper)
     */
     ...
     * this interface, and then call {@link com.jawnnypoo.zed.graphics.GLSurfaceView#setRenderer} to
     ...
     * use the {@link com.jawnnypoo.zed.graphics.GLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     *
     *
     * @see #setRenderer(com.jawnnypoo.zed.graphics.GLSurfaceView.Renderer)
     */
    public interface Renderer {
		...
		void loadTextures(GL10 gl, TextureManager library);
        void flushTextures(GL10 gl, TextureManager library);
        void loadBuffers(GL10 gl, BufferManager library);
        void flushBuffers(GL10 gl, BufferManager library);
     ...
     * {@link com.jawnnypoo.zed.graphics.GLSurfaceView#setEGLContextFactory(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link com.jawnnypoo.zed.graphics.GLSurfaceView#setEGLWindowSurfaceFactory(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link com.jawnnypoo.zed.graphics.GLSurfaceView#setEGLConfigChooser(com.jawnnypoo.zed.graphics.GLSurfaceView.EGLConfigChooser)}
     */
